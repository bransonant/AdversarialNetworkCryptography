# -*- coding: utf-8 -*-
"""
Created on Sun Nov 16 18:37:38 2019
...
# Function used to get the theano tensor from the class if class was passed to layer instead of raw tensor
...
class HiddenLayer():
    def __init__(self, source, input_size, hidden_size, name, act_fn):
        ...
        # Calculate output
        self.output_pre_activ = T.dot(self.source, self.W) + self.b.dimshuffle('x', 0)
